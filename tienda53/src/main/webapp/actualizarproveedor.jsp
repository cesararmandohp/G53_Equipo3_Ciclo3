...
<body>
	...
	<nav class="navbar navbar-dark bg-primary">
		...
		<center><h1 class= "titulomoduloActualizar"> </i> Módulo actualizar proveedor</h1></center>
<br>
	<br>
			...
			<form id="form1">
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon2">Ciudad</span> <input
						type="text" class="form-control"
						placeholder="Inserte ciudad aquí..."
						aria-describedby="basic-addon2" required id="ciudad_proveedor">
				</div>

				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon3">Dirección</span> <input
						type="text" class="form-control"
